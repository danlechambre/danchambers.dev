...
type MdxFrontmatter_dateCreatedArgs = {
  difference: InputMaybe<Scalars['String']>;
  formatString: InputMaybe<Scalars['String']>;
  fromNow: InputMaybe<Scalars['Boolean']>;
  locale: InputMaybe<Scalars['String']>;
...
type TagPageQuery = { readonly allMdx: { readonly edges: ReadonlyArray<{ readonly node: { readonly id: string, readonly excerpt: string | null, readonly frontmatter: { readonly dateCreated: string | null, readonly dateUpdated: string | null, readonly slug: string | null, readonly title: string | null } | null } }> } };

type TagsQueryVariables = Exact<{ [key: string]: never; }>;


type TagsQuery = { readonly allMdx: { readonly distinct: ReadonlyArray<string> } };

type TagsPageQueryVariables = Exact<{ [key: string]: never; }>;


type TagsPageQuery = { readonly allMdx: { readonly distinct: ReadonlyArray<string> } };

type WritingLayoutArticlesQueryVariables = Exact<{ [key: string]: never; }>;


type WritingLayoutArticlesQuery = { readonly allMdx: { readonly nodes: ReadonlyArray<{ readonly frontmatter: { readonly slug: string | null, readonly title: string | null } | null }> } };
