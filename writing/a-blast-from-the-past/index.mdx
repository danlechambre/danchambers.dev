...
![Screenshot of Synthanoid on the Simmer home-page](./synthanoid-simmer.png)

The project can be found on [Github](https://github.com/dc-sts/Synthanoid) and a [WebGL build](https://simmer.io/@danlechambre/synthanoid) of the game is still up on Simmer.
